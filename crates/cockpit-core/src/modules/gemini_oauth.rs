...
const GEMINI_OAUTH_CLIENT_ID: &str = match option_env!("GEMINI_OAUTH_CLIENT_ID") { Some(v) => v, None => "" };
const GEMINI_OAUTH_CLIENT_SECRET: &str = match option_env!("GEMINI_OAUTH_CLIENT_SECRET") { Some(v) => v, None => "" };
