...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // 许可证检查
            modules::license::check_license_on_startup();
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // License
            crate::modules::license::activate_license,
            crate::modules::license::get_license_status,
            crate::modules::license::get_full_machine_id,
            crate::modules::license::generate_license_code,
        ])
