...
const GEMINI_OAUTH_CLIENT_ID: &str = option_env!("GEMINI_OAUTH_CLIENT_ID").unwrap_or("");
const GEMINI_OAUTH_CLIENT_SECRET: &str = option_env!("GEMINI_OAUTH_CLIENT_SECRET").unwrap_or("");
